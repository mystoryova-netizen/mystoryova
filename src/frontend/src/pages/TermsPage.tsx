    ...
    <div className="max-w-4xl mx-auto px-6 py-20">
      ...
      <div className="space-y-10 text-foreground/90 leading-relaxed">
        <section>
          ...
          <p>
            By accessing or using Mystoryova (mystoryova.com), you agree to be
            bound by these Terms and Conditions. If you do not agree with any
            part of these terms, please do not use this website. These terms
            apply to all visitors, readers, and anyone who accesses or uses the
            site.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Books featured on this site are sold through Amazon. When you click
            an Amazon purchase link, you are redirected to Amazon&apos;s website
            and your transaction is governed by Amazon&apos;s own terms and
            conditions. Mystoryova is not a party to any such transaction and
            accepts no responsibility for purchases, refunds, delivery, or any
            issues arising from third-party transactions. Please review
            Amazon&apos;s policies before making a purchase.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            the site shall not exceed the amount you paid to access the site
            (which, as a free service, is zero).
          </p>
        </section>
